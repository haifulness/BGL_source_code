...
module_05 = nn.Linear(SIZE_HIDDEN_LAYER, SIZE_OUTPUT)
net:add(module_01)
net:add(module_02)
net:add(module_03)
net:add(module_04)
...
-- Plot
gnuplot.pngfigure('graph/Dec 17/kok_night_deep.png')
