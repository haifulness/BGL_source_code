...
-- Author: Hai Tran
-- Date: Dec 15, 2015
-- Filename: bgl_pca.lua
-- Descriptiion: Principle Component Analysis.
-- Used for extracting the most significant dimensions of a multidimensional 
-- dataset. 
--
]]

require 'torch'
require("torch7-decomposition/decomposition/pca.lua")
